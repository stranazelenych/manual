...
- Komunikujte s dobrovolníky a vyjadřujte jim poděkování, zároveň (po dohodě s nimi) ukazujte veřejně konkrétní příklady toho, jak dobrovolníci pomáhají - pokud občané uvidí, kdo všechno se do pomoci zapojil (například lidé různého věku), více lidí se může mít ochotu přidat. 
